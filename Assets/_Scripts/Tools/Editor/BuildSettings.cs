...
namespace SGJGrenoble2023 {
    ...
    public class BuildSettings : ScriptableObject, IAssetBookmark {
        ...
        public void Build() {
            ...
            var buildPath = Path.Combine(Application.dataPath, "..", "Builds", _buildName, _buildVersion,
        ...
        public void Deploy() {
            ...
            var butlerPath = Path.Combine(Application.dataPath, "Plugins", "Butler", "butler.exe");
